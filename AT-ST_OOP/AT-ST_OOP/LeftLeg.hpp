...
public:
    LeftLeg();      // constructor
    LeftLeg(float _upperLegRadius, float _mediumLegRadius, float _loweLegRadius, float _upperLegHeight, float _mediumLegHeight, float _loweLegHeight, float _feetWidth, float _feetLenght, float _bodyRadius, float _feetHeight);
    ~LeftLeg();    // destructor
